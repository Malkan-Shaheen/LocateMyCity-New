...
export default function RockFAQSection() {
  const faqs = [
    {
      question: 'Which U.S. state has the most cities with “Rock” in the name?',
      answer: 'Pennsylvania and Maryland have the most “Rock” cities, including Little Rock and Rockwall, due to geographic and historical naming influences.',
    },
    {
      question: 'Can I view all “Rock” cities on an interactive map?',
      answer: 'Yes — the interactive map displays all U.S. cities with “Rock” in their names, complete with coordinates, filters, and quick view links.',
    },
    {
