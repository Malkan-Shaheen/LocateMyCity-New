...
export default function DistanceCalculator() {
 ...
 const handleCalculate = () => {
  ...
  // ✅ Error handling for same source and destination
  if (
    sourcePlace.display_name.toLowerCase().trim() === 
    destinationPlace.display_name.toLowerCase().trim()
  ) {
    alert('Source and Destination cannot be the same. Please choose different locations.');
    return;
  }
  ...
  router.push(`/how-far-is-${sourceSlug}-from-${destSlug}`);
};
