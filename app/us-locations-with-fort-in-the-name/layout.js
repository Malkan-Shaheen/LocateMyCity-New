...
export async function generateMetadata() {
  return {
    title: "U.S. Cities with 'Fort' in Their Name | LocateMyCity",
    description:
      "Explore a complete list of U.S. cities and towns that include the word 'Fort' in their name. View locations, states, and interactive map tools.",
    ...
    twitter: {
      ...
      title: "U.S. Cities with 'Fort' in Their Name | LocateMyCity",
      description:
        "Explore a full list of U.S. places that include 'Fort' in the name, complete with mapping tools and geographic insights.",
    },
    alternates: {
      canonical: "https://locatemycity.com/us-locations-with-fort-in-the-name",
    },
    keywords: [
      "cities with fort in the name",
      "towns with fort",
      "US cities fort",
      "places named fort",
      "fort locations usa",
      "LocateMyCity fort dataset",
    ],
  };
}
