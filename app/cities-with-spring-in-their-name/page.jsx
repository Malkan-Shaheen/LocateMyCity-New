...
import SpringFAQSection from '../../components/SpringFAQSection';
...
export default function SpringLocationsExplorer() {
  ...
  const focusOnLocation = useCallback((lat, lon, name) => {
    ...
    window.open(`/how-far-is-${cleanName}-from-me`, '_blank', 'noopener,noreferrer');
  ...
  return (
    <>
      ...
      <main>
        ...
        {/* City Theme Links */}
        <CityThemeLinks currentTheme="spring" />
